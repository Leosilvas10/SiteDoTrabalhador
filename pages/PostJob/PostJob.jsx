...
const PostJob = () => {
    return (
        <>
            ...
            <PageContainer>
                <form name="post_job">
                    <Heading center size="lg" bottom="5rem">
                        Post A Job
                    </Heading>
                    <InputContainer>
                        {" "}
                        <InputText name="title" placeholder="JOB TITLE" />{" "}
                    </InputContainer>
                    <InputContainer>
                        {" "}
                        <InputText name="salary" placeholder="SALARY" />{" "}
                    </InputContainer>
                    ...
                    <InputContainer style={{ lineHeight: "5rem" }}>
                        ...
                        <label
                            style={{ fontSize: "1.5rem", marginLeft: "5rem" }}
                        >
                            <input type="radio" value="Part" name="time" /> Part
                            Time
                        </label>
                    </InputContainer>
